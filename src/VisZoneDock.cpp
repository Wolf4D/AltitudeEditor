    ...
    : QDockWidget(QStringLiteral("Visibility Zones & Portals (PVS)"), parent)
{
    ...
    setStyleSheet(QStringLiteral(
        ...
        "  background: #181b24;"
        "  color: #ffffff;"
        "  selection-background-color: #2b3d59;"
    ...
    m_lblStats->setStyleSheet(QStringLiteral("background-color: #181b24; border: 1px solid #2e3545; border-radius: 4px; padding: 6px; color: #7cb7ff; font-weight: bold;"));
    ...
    lblPortals->setStyleSheet(QStringLiteral("color: #9bb0d0; font-weight: bold; font-size: 11px;"));
    ...
    lblEntities->setStyleSheet(QStringLiteral("color: #9bb0d0; font-weight: bold; font-size: 11px;"));
